  ...
  <section>
    ...
    <div class="flex justify-center px-20 py-10">
      <div class="fileUpload relative flex w-60 cursor-pointer items-center justify-center overflow-hidden rounded-lg bg-[#b53836ff] py-5 text-white duration-300 hover:shadow-2xl">
        <input type="file" name="videoFile" class="upload absolute bottom-0 left-0 right-0 top-0 m-0 cursor-pointer p-0 opacity-0 filter-none" />
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" class="mr-2" fill="currentColor" viewBox="0 0 107.07 122.88" style="enable-background: new 0 0 107.07 122.88" xml:space="preserve">
          <g>
    ...
    <div class="mb-20 px-20 py-10">
      ...
      <div class="mt-32 flex items-center justify-center">
        <button type="submit" class="flex rounded-lg border-0 bg-[#b53836ff] bg-opacity-75 px-8 py-4 text-white outline-none hover:bg-opacity-100 focus:outline-none">
