<template>
  ...
  <div class="mt-14 flex flex-col items-center justify-center">
    <p class="my-5 text-center text-lg text-red-600" v-if="GlobalData.errMessage">{{ GlobalData.errMessage === ' Conversion failed!!' ? 'Conversion failed!! Try changing editing options or change the video.' : GlobalData.errMessage }}</p>
